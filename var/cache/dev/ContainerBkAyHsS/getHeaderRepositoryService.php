...
class getHeaderRepositoryService extends App_KernelDevDebugContainer
{
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).'/src/Repository/HeaderRepository.php';

        return $container->privates['App\\Repository\\HeaderRepository'] = new \App\Repository\HeaderRepository(($container->services['doctrine'] ?? self::getDoctrineService($container)));
    }
}
