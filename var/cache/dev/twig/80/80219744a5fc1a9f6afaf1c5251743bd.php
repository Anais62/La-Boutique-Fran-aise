...
class __TwigTemplate_34c4f376e9aa938faf3962fab39f6460 extends Template
{
    private $source;
    private $macros = [];
    ...
    <span class=\"product-price\">";
        // line 5
        echo twig_escape_filter($this->env, _twig_default_filter(twig_number_format_filter($this->env, (twig_get_attribute($this->env, $this->source, (isset($context["product"]) || array_key_exists("product", $context) ? $context["product"] : (function () { throw new RuntimeError('Variable "product" does not exist.', 5, $this->source); })()), "price", [], "any", false, false, false, 5) / 100), 2, ",", ""), "0.00"), "html", null, true);
        echo "€</span>
    ...
    {
        return array (  62 => 5,  58 => 4,  54 => 3,  46 => 2,  43 => 1,);
    }
    ...
    <span class=\"product-price\">{{ (product.price / 100)|number_format(2, ',', '')|default('0.00') }}€</span>


</div>", "product/single_product.html.twig", "/var/www/html/la-boutique/templates/product/single_product.html.twig");
    }
}
