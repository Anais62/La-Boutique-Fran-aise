...
class __TwigTemplate_b37bba123369e0994cfd4d6e2e096198 extends Template
{
    private $source;
    private $macros = [];
...
Bienvenue ";
        // line 7
        echo twig_escape_filter($this->env, twig_get_attribute($this->env, $this->source, twig_get_attribute($this->env, $this->source, (isset($context["app"]) || array_key_exists("app", $context) ? $context["app"] : (function () { throw new RuntimeError('Variable "app" does not exist.', 7, $this->source); })()), "user", [], "any", false, false, false, 7), "firtsname", [], "any", false, false, false, 7), "html", null, true);
...
";
    ...
    {
        return array (  98 => 11,  91 => 7,  88 => 6,  78 => 5,  59 => 3,  36 => 1,);
    }
...
{% endblock %}
", "account/index.html.twig", "/var/www/html/test/templates/account/index.html.twig");
    }
}
