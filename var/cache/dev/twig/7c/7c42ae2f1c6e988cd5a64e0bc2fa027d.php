...
class __TwigTemplate_2d1b1de9995ec8379440ef9a3d6f6454 extends Template
{
    private $source;
    private $macros = [];
...
{% for js_asset in assets %}
    ...
    {% endif %}
{% endfor %}
", "@EasyAdmin/includes/_js_assets.html.twig", "/var/www/html/test/vendor/easycorp/easyadmin-bundle/src/Resources/views/includes/_js_assets.html.twig");
    }
}
